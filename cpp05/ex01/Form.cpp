...
Form::Form(const std::string N, int gradeToSign, int gradeToExecute): name(N), GRADE_REQUIRED_TO_SIGN(gradeToSign), GRADE_REQUIRED_TO_EXECUTE(gradeToExecute)
{
...
Form::Form(const Form& other): name(other.name), GRADE_REQUIRED_TO_SIGN(other.GRADE_REQUIRED_TO_SIGN), GRADE_REQUIRED_TO_EXECUTE(other.GRADE_REQUIRED_TO_EXECUTE)
{
